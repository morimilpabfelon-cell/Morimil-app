...
class ReasoningUsageLedgerTest {
    ...
    fun ledgerMathAccumulatesSuccessFailureAndTokenTotals() {
        ...
        assertEquals(2, totals.requestCount)
        assertEquals(1, totals.successCount)
        assertEquals(1, totals.failureCount)
        assertEquals(1, totals.truncatedCount)
        assertEquals(1, totals.continuationCount)
        assertEquals(180, totals.estimatedRequestTokens)
        assertEquals(25, totals.estimatedResponseTokens)
        assertEquals(90, totals.apiInputTokens)
        assertEquals(40, totals.apiCachedInputTokens)
        assertEquals(20, totals.apiOutputTokens)
        assertEquals(5, totals.apiReasoningTokens)
        assertEquals(110, totals.apiTotalTokens)
    }
}
