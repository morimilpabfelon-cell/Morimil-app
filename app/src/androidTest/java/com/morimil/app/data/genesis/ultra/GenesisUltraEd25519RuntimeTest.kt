...
class GenesisUltraEd25519RuntimeTest {
    @Test
    fun officialVectorVerifiesAcrossSupportedAndroidApis() {
        ...
        assertTrue("Tink Ed25519 must verify on Android API ${Build.VERSION.SDK_INT}", verified)
    }

    @Test
    fun alteredSignatureFailsClosedAcrossSupportedAndroidApis() {
        val publicKey = GenesisUltraHashProfile.decodeLowerHex(
            "d04ab232742bb4ab3a1368bd4615e4e6d0224ab71a016baf8520a332c9778737"
        )
        val envelope = GenesisUltraSignatureEnvelope(
            ...
            signedDomain = "genesis.crypto.vector.signature.v0.1",
            signedDigest = "sha256:" + "a".repeat(64),
            signatureValue = "00" + "389deebe9b4ff2142a6fbb2cc28c4766b85db9eb58c2e1ba5673b3feb50e79d432317e68aca86648ff1ec011ff9c36552c590f67e9ef38911721d4f25edde500".drop(2),
            createdAt = "2026-07-15T02:30:00Z",
            publicKeyRef = "sha256:10ba682c8ad13513971e8b56881aab8bd702bb807796eca81932c735a94d6e6d"
        )
        val verifier = GenesisUltraEd25519SignatureVerifier(
        ...
        assertFalse(
            "Altered Ed25519 signature must fail on Android API ${Build.VERSION.SDK_INT}",
